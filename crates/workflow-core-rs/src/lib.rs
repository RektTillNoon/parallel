...
pub use resolver::{migrate_legacy_watched_roots, resolve_index_db_path, resolve_watched_roots, RootResolutionSurface};
pub use read_model::{board_project_detail as get_board_project_detail, list_indexed_projects, list_projects};
pub use services::{
